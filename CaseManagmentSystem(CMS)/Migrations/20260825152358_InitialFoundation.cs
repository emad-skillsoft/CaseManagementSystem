        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExternalCaseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Priority = table.Column<int>(type: "int", nullable: false),
                    SLAStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ImportedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AssignedExpertId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CurrentWorkflowStageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cases_AspNetUsers_AssignedExpertId",
                        column: x => x.AssignedExpertId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cases_WorkflowStages_CurrentWorkflowStageId",
                        column: x => x.CurrentWorkflowStageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CaseStatusHistories_AspNetUsers_PerformedByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CaseStatusHistories_WorkflowStages_NewStageId",
                        column: x => x.NewStageId,
                        principalTable: "WorkflowStages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CaseStatusHistories_WorkflowStages_PreviousStageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cases_AssignedExpertId",
                table: "Cases",
                column: "AssignedExpertId");

            migrationBuilder.CreateIndex(
                name: "IX_Cases_CurrentWorkflowStageId",
                table: "Cases",
                column: "CurrentWorkflowStageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseStatusHistories_NewStageId",
                table: "CaseStatusHistories",
                column: "NewStageId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseStatusHistories_PerformedByUserId",
                table: "CaseStatusHistories",
                column: "PerformedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseStatusHistories_PreviousStageId",
                table: "CaseStatusHistories",
                column: "PreviousStageId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowTransitions_FromStageId",
